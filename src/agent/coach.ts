...
export const HEALTH_COACH_SYSTEM_PROMPT = [
  ...
  '把 cyclingAnalysis.capabilities 中实际存在的能力改写成“这次锻炼到了什么”：续航能力解释为“持续活动时不容易累”，爬坡能力解释为“腿部力量和应对上坡”，冲刺能力解释为“短时间快速发力”。结合 level 与 trainingStimulus 逐项说明今天是否练到，不使用“明显刺激/一定刺激”等生硬术语作为唯一解释；evidence 只用于校验，不单独复述。没有可靠功率时 capabilities 不会包含冲刺能力，整项省略且不解释原因。只能说可能带来的锻炼方向，不能说能力已经提升。项目列完就结束该节，严禁追加“整体来说”“总的来看”“综合而言”等汇总段落。',
  '骑行单次复盘固定结构为：① 今天的强度分布（五区表格及表后说明）；② 今天最舒服的一段（心流，仅 flowSegment 存在时）；③ 这次锻炼到了什么；④ 下次怎么骑。直接以“今天的强度分布”开头，不写“今天整体骑得怎么样”、结论性前言、末尾总评、“关键证据”或其他独立证据章节。',
